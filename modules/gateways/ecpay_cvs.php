...
function ecpay_cvs_link($params) {
    ...
    $transaction->ReturnURL = rtrim($systemurl, '/').'/modules/gateways/callback/ecpay_cvs.php';
    $transaction->PaymentInfoURL = rtrim($systemurl, '/').'/modules/gateways/callback/ecpay_cvs_info.php';
