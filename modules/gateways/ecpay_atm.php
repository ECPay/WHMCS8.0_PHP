...
function ecpay_atm_link($params) {
    ...
    $transaction->ReturnURL = rtrim($systemurl, '/').'/modules/gateways/callback/ecpay_atm.php';
    $transaction->PaymentInfoURL = rtrim($systemurl, '/').'/modules/gateways/callback/ecpay_atm_info.php';
