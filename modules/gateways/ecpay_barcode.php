...
function ecpay_barcode_link($params) {
    ...
    $transaction->ReturnURL = rtrim($systemurl, '/').'/modules/gateways/callback/ecpay_barcode.php';
    $transaction->PaymentInfoURL = rtrim($systemurl, '/').'/modules/gateways/callback/ecpay_barcode_info.php';
